# Generated by Django 2.2.4 on 2019-12-24 13:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sport', models.CharField(choices=[('Boxing', 'Бокс'), ('Kickboxing', 'Кикбоксинг')], default='Boxing', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('Doctor', 'Врач'), ('Participant', 'Участник'), ('Coach', 'Тренер'), ('Sponsor', 'Cпонсор')], default='Participant', max_length=100)),
                ...
                ('userid', models.ForeignKey(default=2, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
